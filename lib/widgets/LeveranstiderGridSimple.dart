...
class LeveranstiderGridSimple extends StatefulWidget {
  final Function(String) onSelectSlot;

  const LeveranstiderGridSimple({
    super.key,
    required this.onSelectSlot,
  });

  @override
  State<LeveranstiderGridSimple> createState() => _LeveranstiderGridSimpleState();
}

class _LeveranstiderGridSimpleState extends State<LeveranstiderGridSimple> {
      ...
      children: [
        Row(
          ...
          children: [
            ...
            const Text('Se lediga leveranstider', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(width: 8),
            IconButton(
